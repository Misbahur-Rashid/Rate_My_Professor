...
@section('content')
    ...
    <li class="breadcrumb-item"><a >School Information</a></li>
    @endcomponent
            ...
            <div class="col-12">
                <div class="material-card card">
                    <div class="card-header">
						<div class="pull-left">
							<h6 class="card-title mt-1">School</h6>
						</div>
						<div class="pull-right">
                            <a href="{{url('/admin/get-role-school-added')}}" class="btn btn-outline-info btn-sm"><i class="mdi mdi-plus-circle"></i> Create School</a>
						</div>
					</div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    @foreach($School as $row)
                                        <tr>
                                            ...
                                            @endif
                                            <td>
                                                <a href="{{url('admin/get-role-school-added/'. $row->id)}}"><button class="btn btn-success btn-circle btn-sm"><i class="mdi mdi-pencil"></i></button></a>
                                                <button data-url="{{url('admin/get-role-school-delete/'.$row->id)}}" class="btn-delete btn btn-danger btn-circle btn-sm" data-toggle="modal" data-target="#deleteModal"><i class="mdi mdi-delete"></i></button>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
