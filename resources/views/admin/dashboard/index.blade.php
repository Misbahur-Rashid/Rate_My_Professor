...
@push('css')
    <!-- <link href="{{asset('contents/admin/assets/libs/chartist/dist/chartist.min.css')}}" rel="stylesheet">
    <link href="{{asset('contents/admin/assets/libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.css')}}" rel="stylesheet">
    <link href="{{asset('contents/admin/assets/libs/morris.js/morris.css')}}" rel="stylesheet">
    <link href="{{asset('contents/admin/assets/extra-libs/c3/c3.min.css')}}" rel="stylesheet">
    <link href="{{asset('contents/admin/assets/libs/fullcalendar/dist/fullcalendar.min.css')}}" rel="stylesheet" />
    <link href="{{asset('contents/admin/assets/extra-libs/calendar/calendar.css')}}" rel="stylesheet" /> -->
@endpush
        ...
        <div class="card-group">
            <div class="card p-2 mr-2 p-lg-3">
                <div class="p-lg-3 p-2">
                        <div class="ml-4" style="width: 38%;">
                            @php
                            $userCount=App\User::where('role_id',2)->count();
                            @endphp
                            <h4 class="font-light" style="background-color:yellow;font-size:700;width:150px;padding:15px">Total Student</h4>
                        </div>
                        <div class="ml-auto" style="padding-left: 80px">
                        <h2 class="display-7 mb-0">{{$userCount}}</h2>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-group">
                <div class="card p-2 mr-2 p-lg-3">
                    <div class="p-lg-3 p-2">
                            <div class="ml-4" style="width: 38%;">
                                <h4 class="font-light" style="background-color:orange;font-size:700;width:150px;padding:15px">Total Course</h4>
                            </div>
                            <div class="ml-auto" style="padding-left: 80px">
                                 {{-- @php
                            $courseCount=App\Course::where('status',1)->count();
                            @endphp --}}
...
{{-- <!--         {{Carbon\Carbon::yesterday()->diffInDays()}}<br>
        {{Carbon\Carbon::now()->format("D d-M-Y h:i:s A")}}<br>
        {{Carbon\Carbon::now()->format("m")}}<br> --}}

        {{-- <div class="card-group">
            <div class="card p-2 mr-2 p-lg-3">
                <div class="p-lg-3 p-2">
                    <div class="d-flex align-items-center">
                        <button class="btn btn-circle text-white btn-lg  @if($todayOrder->count() > $yesterdayOrder->count()) {{'btn-success'}} @elseif($todayOrder->count() < $yesterdayOrder->count() || $todayOrder->count() == 0) {{'btn-danger'}} @else {{'btn-cyan'}} @endif" href="javascript:void(0)">
                            <i class="ti-shopping-cart"></i>
                        </button>
                        <div class="ml-4" style="width: 38%;">
                            <h4 class="font-light">Today Orders</h4>
                            <div class="progress">
                                <div class="progress-bar  @if($todayOrder->count() > $yesterdayOrder->count()) {{'bg-success'}} @elseif($todayOrder->count() < $yesterdayOrder->count() || $todayOrder->count() == 0) {{'bg-danger'}} @else {{'bg-cyan'}} @endif" role="progressbar" style="width: {{$thisYearOrder->count() > 0 ? ($todayOrder->count()/$thisYearOrder->count()) * 100 : 0}}%" aria-valuenow="40" aria-valuemin="0" aria-valuemax="40"></div>
                            </div>
                        </div>
                        <div class="ml-auto">
                            <h2 class="display-7 mb-0">{{$todayOrder->count()}}</h2>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card p-2 mr-2 p-lg-3">
                <div class="p-lg-3 p-2">
                    <div class="d-flex align-items-center">
                        <button class="btn btn-circle text-white btn-lg @if($thisMonthOrder->count() > $previousMonthOrder->count()) {{'btn-success'}} @elseif($thisMonthOrder->count() < $previousMonthOrder->count() || $thisMonthOrder->count() == 0) {{'btn-danger'}} @else {{'btn-cyan'}} @endif" href="javascript:void(0)">
                            <i class="ti-shopping-cart"></i>
                        </button>
                        <div class="ml-4" style="width: 38%;">
                            <h4 class="font-light">This Month Orders</h4>
                            <div class="progress">
                                <div class="progress-bar @if($thisMonthOrder->count() > $previousMonthOrder->count()) {{'bg-success'}} @elseif($thisMonthOrder->count() < $previousMonthOrder->count() || $thisMonthOrder->count() == 0) {{'bg-danger'}} @else {{'bg-cyan'}} @endif" role="progressbar" style="width: {{$thisYearOrder->count() > 0 ? ($thisMonthOrder->count()/$thisYearOrder->count()) * 100 : 0}}%" aria-valuenow="40" aria-valuemin="0" aria-valuemax="40">
                                </div>
                            </div>
                        </div>
                        <div class="ml-auto">
                            <h2 class="display-7 mb-0">{{$thisMonthOrder->count()}}</h2>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card p-2 mr-2 p-lg-3">
                <div class="p-lg-3 p-2">
                    <div class="d-flex align-items-center">
                        <button class="btn btn-circle text-white btn-lg @if($thisYearOrder->count() > $previousYearOrder->count()) {{'btn-success'}} @elseif($thisYearOrder->count() < $previousYearOrder->count() || $thisYearOrder->count() == 0) {{'btn-danger'}} @else {{'btn-cyan'}} @endif" href="javascript:void(0)">
                            <i class="ti-shopping-cart"></i>
                        </button>
                        <div class="ml-4" style="width: 38%;">
                            <h4 class="font-light">This Year Orders</h4>
                            <div class="progress">
                                <div class="progress-bar @if($thisYearOrder->count() > $previousYearOrder->count()) {{'bg-success'}} @elseif($thisYearOrder->count() < $previousYearOrder->count() || $thisYearOrder->count() == 0) {{'bg-danger'}} @else {{'bg-cyan'}} @endif" role="progressbar" style="width: {{$thisYearOrder->count() > 0 ? 100 : 0}}%" aria-valuenow="40" aria-valuemin="0" aria-valuemax="40"></div>
                            </div>
                        </div>
                        <div class="ml-auto">
                            <h2 class="display-7 mb-0">{{$thisYearOrder->count()}}</h2>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="table-responsive border-top manage-table px-4 py-3">
                                    <table class="table no-wrap">
                                        ...
                                        <tr class="advanced-table active">
                                            ...
                                            <td>
                                                <img src="{{asset('contents/admin/assets/images/users/1.jpg')}}" class="rounded-circle" width="30">
                                            </td>
                                            <td>Andrew Simons</td>
                                            <td>Modulator</td>
                                            <td>6 May 2016</td>
                                        ...
                                        <tr class="advanced-table">
                                            ...
                                            <td>
                                                <img src="{{asset('contents/admin')}}/assets/images/users/2.jpg" class="rounded-circle" width="30">
                                            </td>
                                            <td>Hanna Gover</td>
                                            <td>Admin </td>
                                            <td>13 Jan 2005</td>
                                        ...
                                        <tr class="advanced-table">
                                            ...
                                            <td>
                                                <img src="{{asset('contents/admin')}}/assets/images/users/3.jpg" class="rounded-circle" width="30">
                                            </td>
                                            <td>Joshi Nirav</td>
                                            <td>Admin</td>
                                            <td>21 Mar 2001</td>
                                        ...
                                        <tr class="advanced-table">
                                            ...
                                            <td>
                                                <img src="{{asset('contents/admin')}}/assets/images/users/4.jpg" class="rounded-circle" width="30">
                                            </td>
                                            <td>Joshi Sunil</td>
                                            <td>Admin</td>
                                            <td>21 Mar 2004</td>
                            ...
                            <ul class="list-task todo-list list-group mb-0" data-role="tasklist">
                                <li class="list-group-item todo-item pt-0" data-role="task">
                                    ...
                                    <ul class="list-style-none assignedto mt-2">
                                        <li class="assignee"><img class="assignee-img" src="{{asset('contents/admin')}}/assets/images/users/1.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Steave"></li>
                                        <li class="assignee"><img class="assignee-img" src="{{asset('contents/admin')}}/assets/images/users/2.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Jessica"></li>
                                        <li class="assignee"><img class="assignee-img" src="{{asset('contents/admin')}}/assets/images/users/3.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Priyanka"></li>
                                        <li class="assignee"><img class="assignee-img" src="{{asset('contents/admin')}}/assets/images/users/4.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Selina"></li>
                                    </ul>
                                </li>
        ...
        <!-- <div class="row">
            <div class="col-md-6 col-lg-4">
                <div class="card">
                    <img class="card-img-top" src="{{asset('contents/admin')}}/assets/images/big/img1.jpg" alt="Card image cap">
                    <div class="card-body">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card">
                    <img class="card-img-top" src="{{asset('contents/admin')}}/assets/images/big/img3.jpg" alt="Card image cap">
                    <div class="card-body">
                        <div class="d-flex no-block align-items-center mb-3">
                        ...
                        <ul class="list-style-none chat-list">
                            <li class="mb-3">
                                <a href="javascript:void(0)">
                                    <div class="d-flex align-items-center">
                                        <img src="{{asset('contents/admin')}}/assets/images/users/1.jpg" class="rounded-circle" width="40">
                                        <div class="ml-3">
                            ...
                            <li class="mb-3">
                                <a href="javascript:void(0)">
                                    <div class="d-flex align-items-center">
                                        <img src="{{asset('contents/admin')}}/assets/images/users/2.jpg" class="rounded-circle" width="40">
                                        <div class="ml-3">
                            ...
                            <li class="mb-3">
                                <a href="javascript:void(0)">
                                    <div class="d-flex align-items-center">
                                        <img src="{{asset('contents/admin')}}/assets/images/users/3.jpg" class="rounded-circle" width="40">
                                        <div class="ml-3">
                            ...
                            <li class="mb-3">
                                <a href="javascript:void(0)">
                                    <div class="d-flex align-items-center">
                                        <img src="{{asset('contents/admin')}}/assets/images/users/4.jpg" class="rounded-circle" width="40">
                                        <div class="ml-3">
                            ...
                            <li class="mb-3">
                                <a href="javascript:void(0)">
                                    <div class="d-flex align-items-center">
                                        <img src="{{asset('contents/admin')}}/assets/images/users/5.jpg" class="rounded-circle" width="40">
                                        <div class="ml-3">
                            ...
                            <li class="mb-3">
                                <a href="javascript:void(0)">
                                    <div class="d-flex align-items-center">
                                        <img src="{{asset('contents/admin')}}/assets/images/users/6.jpg" class="rounded-circle" width="40">
                                        <div class="ml-3">
                                            <h5 class="mb-0 text-dark">Varun Dhavan</h5>
                                            <small class="text-success">Online</small>
                                        </div>
                        ...
                        <div class="steamline mt-0">
                            ...
                            <div class="sl-item">
                                ...
                                <div class="sl-right">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col">
                                            <img src="{{asset('contents/admin')}}/assets/images/big/img1.jpg" class="img-fluid">
                                        </div>
                                        <div class="col">
                                            <img src="{{asset('contents/admin')}}/assets/images/big/img2.jpg" class="img-fluid">
                                        </div>
                                        <div class="col">
                                            <img src="{{asset('contents/admin')}}/assets/images/big/img3.jpg" class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="sl-item">
                                <div class="sl-left"> <img src="{{asset('contents/admin')}}/assets/images/users/1.jpg" alt="user" class="rounded-circle" /> </div>
                                <div class="sl-right">
                            ...
                            <div class="sl-item">
                                <div class="sl-left"> <img src="{{asset('contents/admin')}}/assets/images/users/2.jpg" alt="user" class="rounded-circle" /> </div>
                                <div class="sl-right">
                            ...
                            <div class="sl-item">
                                <div class="sl-left"> <img src="{{asset('contents/admin')}}/assets/images/users/5.jpg" alt="user" class="rounded-circle" /> </div>
                                <div class="sl-right">
...
@endsection
@push('js')
    <!-- <script src="{{asset('contents/admin/assets/libs/chartist/dist/chartist.min.js')}}"></script>
    <script src="{{asset('contents/admin/dist/js/pages/chartist/chartist-plugin-tooltip.js')}}"></script>
    <script src="{{asset('contents/admin/assets/extra-libs/c3/d3.min.js')}}"></script>
    <script src="{{asset('contents/admin/assets/extra-libs/c3/c3.min.js')}}"></script>
    ...
    <script src="{{asset('contents/admin/dist/js/pages/dashboards/dashboard1.js')}}"></script>
    <script src="{{asset('contents/admin/assets/libs/moment/min/moment.min.js')}}"></script>
    <script src="{{asset('contents/admin/assets/libs/fullcalendar/dist/fullcalendar.min.js')}}"></script>
    <script src="{{asset('contents/admin/dist/js/pages/calendar/cal-init.js')}}"></script>
    <script>
