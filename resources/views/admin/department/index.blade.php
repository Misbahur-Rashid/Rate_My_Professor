...
@section('content')
    ...
    <li class="breadcrumb-item"><a >Department Information</a></li>
    @endcomponent
            ...
            <div class="col-12">
                <div class="material-card card">
                    <div class="card-header">
						<div class="pull-left">
							<h6 class="card-title mt-1">Department</h6>
						</div>
						<div class="pull-right">
                            <a href="{{url('/admin/get-role-department-added')}}" class="btn btn-outline-info btn-sm"><i class="mdi mdi-plus-circle"></i> Create Department</a>
						</div>
					</div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    @foreach($department as $row)
                                        <tr>
                                            ...
                                            @endif
                                            <td>
                                                <a href="{{url('admin/get-role-department-added/'. $row->id)}}"><button class="btn btn-success btn-circle btn-sm"><i class="mdi mdi-pencil"></i></button></a>
                                                <button data-url="{{url('admin/get-role-department-delete/'.$row->id)}}" class="btn-delete btn btn-danger btn-circle btn-sm" data-toggle="modal" data-target="#deleteModal"><i class="mdi mdi-delete"></i></button>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
            ...
            <div class="modal-content">
                <form  method="post" id="delete-form">
                    ...
                    <div class="modal-body">
                        <h5>Think Before Delete The File!!</h5>
