                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input name="image" type="file" id="input-file-now" class="dropify" data-default-file="{{asset('images/admin_images/admin_gallary/'. $product->image)}}" data-max-file-size="3M">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input name="image_two" type="file" id="input-file-now" class="dropify" data-default-file="{{asset('images/admin_images/admin_gallary/'. $product->image_two)}}" data-max-file-size="3M">
                                    ...
                                    <div class="col-md-3">
                                        <h5 class="card-title mt-3">Product Image</h5>
                                        <input name="image_three" type="file" id="input-file-now" class="dropify" data-default-file="{{asset('images/admin_images/admin_gallary/'. $product->image_three)}}" data-max-file-size="3M">
                                    ...
                                    <div class="col-md-3">
                                        <h5 class="card-title mt-3">Product Image</h5>
                                        <input name="image_four" type="file" id="input-file-now" class="dropify" data-default-file="{{asset('images/admin_images/admin_gallary/'. $product->image_four)}}" data-max-file-size="3M">
