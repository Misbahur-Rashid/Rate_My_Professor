...
@section('content')
    ...
    <li class="breadcrumb-item"><a href="{{url('admin/recycle/user')}}">Recyle Users</a></li>
    @endcomponent
                ...
                <div class="material-card card">
                    <div class="card-header">
						...
						<div class="pull-right">
                            <a href="{{url('/admin/user')}}" class="btn btn-outline-info btn-sm"><i class="mdi mdi-account-multiple"></i>Users</a>
						</div>
					</div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    @foreach($users as $user)
                                        <tr>
                                            ...
                                            @endif
                                            <td>
                                                <a href="{{url('admin/recycle/user/'. $user->id)}}"><button class="btn btn-info btn-circle btn-sm"><i class="mdi mdi-eye"></i></button></a>
                                                <button data-url="{{url('admin/recycle/user/'. $user->id)}}" class="btn-restore btn btn-success btn-circle btn-sm" data-toggle="modal" data-target="#restoreModal"><i class="mdi mdi-recycle"></i></button>
                                                <button data-url="{{url('admin/recycle/user/'.$user->id)}}" class="btn-delete btn btn-danger btn-circle btn-sm" data-toggle="modal" data-target="#deleteModal"><i class="mdi mdi-delete"></i></button>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
