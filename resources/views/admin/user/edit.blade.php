                ...
                <div class="card">
                    <div class="card-header">
						...
						<div class="pull-right">
                            <a href="{{url('/admin/user')}}" class="btn btn-outline-info btn-sm"><i class="mdi mdi-arrow-left"></i> Back</a>
						</div>
					</div>
                    <div class="card-body">
                        <form class="form pt-3" method="post" action="{{url('admin/get-user-added/'.$user->id)}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                <label>User Role</label>
                                    <input type="text" class="form-control" placeholder="role" name="role" value="{{$user->role->role_name}}" disabled>
                                @if ($errors->has('role'))
                                    <span class="invalid-feedback" role="alert">
