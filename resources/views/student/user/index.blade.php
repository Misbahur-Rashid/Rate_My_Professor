                ...
                <div class="material-card card">
                    <div class="card-header">
						...
						<div class="pull-right">
                            ...
                            <a href="{{url('/admin/user/create')}}" class="btn btn-outline-info btn-sm"><i class="mdi mdi-plus-circle"></i> Create User</a>
                            @else
                            <h3>no permission to access</h3>
                            @endif
                        </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach($users as $user)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$user->phone}}</td>
                                            <td>
                                            <img width="30" src="{{asset('images/student/')}}/{{$user->image}}" alt="">
                                            </td>
                                            ...
                                            @endif
                                            <td>
                                                <a href="{{url('author/user/'. $user->id)}}"><button class="btn btn-info btn-circle btn-sm"><i class="mdi mdi-eye"></i></button></a>
                                                <a href="{{url('author/user/'. $user->id. '/edit')}}"><button class="btn btn-success btn-circle btn-sm"><i class="mdi mdi-pencil"></i></button></a>
                                                <button data-url="{{url('author/user/'.$user->id)}}" class="btn-delete btn btn-danger btn-circle btn-sm" data-toggle="modal" data-target="#deleteModal"><i class="mdi mdi-delete"></i></button>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
